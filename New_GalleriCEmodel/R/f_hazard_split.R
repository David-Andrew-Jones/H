...
#'
#' @param net_survival Survival probability
...
#' @examples
#' f_derive_netsurv_cfDNAstatus()
#' @export
f_derive_netsurv_cfDNAstatus <- function(net_survival,
                                         hazard_ratio,
                                         cfDNA_detection_rate){

        internal_function <- function(target_surv){

                (target_surv^hazard_ratio * cfDNA_detection_rate + target_surv * (1 - cfDNA_detection_rate) - net_survival)^2
        }
