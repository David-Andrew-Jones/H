...
weighted_sd_no50 = weighted_stage_dist_by_cancer %>%
...
write.xlsx(np_SD_res_base, sprintf("~/Miscellaneous/Treatments/interception_model_results/%s_np_SD_res_100.xlsx", date_code))
